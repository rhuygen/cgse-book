...
- `egse/registry/` — the service registry, covered last in this arc so its value is clear by contrast with the static-port model covered in Chapter Z.

## Running appendix

**Pitfalls & Cleanup Backlog** (`appendix-pitfalls.md` in the repo) — currently P-001 through P-008. Template included at the bottom of that file for adding new entries in the established format.